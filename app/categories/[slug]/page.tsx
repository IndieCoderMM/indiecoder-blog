...
export const metadata = {
  title: "Explore Latest Articles and Insights on IndieCoder's Blog",
};
...
const CategoryPage = async ({ params }: { params: { slug: string } }) => {
  ...
  return (
    <section className="w-full px-0 py-2 lg:p-8 xl:px-16">
      <header className="space-y-2 border-b-2 border-border md:space-y-4">
        ...
        <p>
          Explore insightful articles on various topics and learn something new
          today.
        </p>
